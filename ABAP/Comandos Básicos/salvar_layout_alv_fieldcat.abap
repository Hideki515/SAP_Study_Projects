*No Alv adicionar os seguintes comandos para que seja possível selecionar o Layout no parametro 
...
*** VARIÁVEIS  ***
******************
DATA gv_variant TYPE disvariant. "Declarar a variavel no código 
